          ...
          <article class="bet-grid">
            ...
            <aside class="bet-grid__slip" data-active-bet-tab="MYBETS">
              <button id="bet-grid-toggle" class="bet-grid__toggle" aria-label="Toggle sections">
                <div class="bet-grid__toggle-icon"></div>
              </button>
